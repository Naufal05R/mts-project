    ...
    <section className="relative mx-auto min-h-screen w-full overflow-clip">
      <div className="absolute z-10 grid h-full w-full place-items-center">
        <div className="w-full text-center text-white">
          <h2 className="text-[34px] font-bold md:text-[45px] xl:text-[65px]">
            MA. Sirojul Falah
          </h2>
          <div className="relative h-[33px] w-full overflow-y-clip md:h-[42px] xl:h-[58.5px]">
            <div className="text-animate absolute flex w-full flex-col">
              <span
